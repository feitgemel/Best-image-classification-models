...
data_set_path = "/mnt/d/Data-Sets-Image-Classification/10 dogs Breeds"
...
num_epochs = 200  # Increased to 50 epochs
...
for epoch in range(num_epochs):
    ...
    if epoch_loss < best_loss:
        ...
        print(f"Epochs without improvement: {no_improve_count}/{patience}")
