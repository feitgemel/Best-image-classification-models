...
best_model_path = "/mnt/d/Temp/Models/lightly-train/Object-Classification/out/70-dogs-breed/fine-tune/best_fine_tuned_resnet50.pth"
data_path = "/mnt/d/Temp/70 dogs breed images-10-random-images"  # Dataset path to retrieve class names
