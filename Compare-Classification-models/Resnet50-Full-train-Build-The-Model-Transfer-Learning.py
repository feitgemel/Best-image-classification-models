...
# Build the model 
basemodel = ResNet50(weights='imagenet', input_shape=(IMAGE_SIZE,IMAGE_SIZE,3), include_top=False)
...
path_for_saved_model = "C:/Data-sets/Stanford Car Dataset/car_data/car_data/ResNet50-V3-car.h5"
