# How to classify images using Vision Transformer (VIT)

<p align="center">
  <img width="800" src="Vision Transformer (ViT).png" "image">
</p>
...
🔍 Creating the Conda enviroment and installing the relevant Python libraries.

🛠️ Learning to code the classification process using the Vision Transformer model.
