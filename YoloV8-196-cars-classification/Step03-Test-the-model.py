...
# load the model 
model = YOLO("C:/Data-sets/Stanford Car Dataset/car_data/My-model/weights/best.pt")
imgPth = "Best-image-classification-models/YoloV8-196-cars-classification/chevrolet-cobalt-ss-supercharged.jpg"
